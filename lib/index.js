(function() {
  var Hook, colors, httpget, url, util;
  ...
  exports.Wget = (function() {
    __extends(Wget, Hook);
    function Wget(options) {
      this._head = __bind(this._head, this);
      this._download = __bind(this._download, this);
      this._buildRequestOptions = __bind(this._buildRequestOptions, this);      var self;
      self = this;
